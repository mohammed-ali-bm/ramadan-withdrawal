...
<x-splade-toggle>
    <nav class="bg-white border-b border-gray-100 header-nav">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:mr-10 sm:flex">
                        <x-nav-link  class="ml-5" :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('الرئيسية') }}
                        </x-nav-link>
                    ...
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                                ...
                                <div class="mr-1">
                                    <svg class="fill-current h-4 w-4" xmrns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
